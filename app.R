...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("(4) Relationship between Previous and Current Time Differences Between Abnormal Events", tabName = "tab4"),
      menuItem("(5) Predicting the Next Time Difference Between Abnormal Events", tabName = "tab5")
    ),
    ...
    conditionalPanel(
      ...
      sliderInput("lag_slider", "Lag:", min = 0, max = 10, value = 5),
